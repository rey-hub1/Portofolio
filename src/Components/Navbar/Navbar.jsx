...
export default function Navbar() {
    return (
        <Disclosure as="nav" className="font-['Playfair'] text-xl text-[#f4f9f8] font-medium" >
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    {/* LOGO */}
                        <div className="flex shrink-0 items-center gap-2 text-3xl border-r px-4 border-gray-300">
                            <h1 className="">R</h1>
